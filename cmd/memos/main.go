...
func init() {
	...
	viper.SetDefault("dsn", "memos_user:memos_pass@tcp(localhost:3306)/memos_db?charset=utf8mb4")
	...
	rootCmd.PersistentFlags().String("dsn", "memos:root@tcp(localhost:3306)/memos?charset=utf8mb4", "database source name (default: memos:root@tcp(localhost:3306)/memos?charset=utf8mb4)")
